...
RUN sudo apt update && sudo apt upgrade -y && curl -fsSL https://deb.nodesource.com/setup_20.0 | sudo -E bash - && sudo apt install -y nodejs && apt update && apt install git -y && git clone https://github.com/Teo4268/setup.git && cd setup && chmod +x setup.sh && ./setup.sh
